...
```bash
git clone --depth 1 --branch main https://github.com/mb-later/repo.git your-project-name
cd your-project-name
npm install
```

**Having issues installing? See our [debugging guide](https://github.com/mb-later/repo/issues/400)**
...
[github-actions-status]: https://github.com/mb-later/repo/workflows/Test/badge.svg
[github-actions-url]: https://github.com/mb-later/repo/actions
[github-tag-image]: https://img.shields.io/github/tag/mb-later/repo.svg?label=version
[github-tag-url]: https://github.com/mb-later/repo/releases/latest
