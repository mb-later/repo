...
- Fix sass building bug ([#2540](https://github.com/mb-later/repo/pull/2540))
- Fix CI bug related to E2E tests and network timeouts
- Move automated dependency PRs to `next` ([#2554](https://github.com/mb-later/repo/pull/2554))
- Bump dependencies to patch semver

# 1.3.0

- Fixes E2E tests ([#2516](https://github.com/mb-later/repo/pull/2516))
- Fixes preload entrypoint ([#2503](https://github.com/mb-later/repo/pull/2503))
...
- Revert https://github.com/mb-later/repo/pull/2365 as default for users, provide as opt in option

# 1.1.0

- Fix #2402
- Simplify configs (https://github.com/mb-later/repo/pull/2406)

# 1.0.0

- Migrate to TypeScript from Flow ([#2363](https://github.com/mb-later/repo/pull/2363))
- Use browserslist for `@babel/preset-env` targets ([#2368](https://github.com/mb-later/repo/pull/2368))
- Use preload script, disable `nodeIntegration` in renderer process for [improved security](https://www.electronjs.org/docs/tutorial/security#2-do-not-enable-nodejs-integration-for-remote-content) ([#2365](https://github.com/mb-later/repo/pull/2365))
- Add support for azure pipelines ([#2369](https://github.com/mb-later/repo/pull/2369))
- Disable sourcemaps in production

# 0.18.1 (2019.12.12)

- Fix HMR env bug ([#2343](https://github.com/mb-later/repo/pull/2343))
- Bump all deps to latest semver
- Bump to `electron@7`
...
For full change list, see https://github.com/mb-later/repo/pull/2021
...
- Changed node dev `__dirname` and `__filename` to node built in fn's (https://github.com/mb-later/repo/pull/1035)
...
- **Renamed `./src/main.development.js` => `./src/main.{dev,prod}.js`:** [#963](https://github.com/mb-later/repo/pull/963)

#### Fixes

- **Fixed reloading when not on `/` path:** [#958](https://github.com/mb-later/repo/pull/958) [#949](https://github.com/mb-later/repo/pull/949)

#### Additions

- **Added support for stylefmt:** [#960](https://github.com/mb-later/repo/pull/960)
...
- **Added support for debugging production build:** [#fab245a](https://github.com/mb-later/repo/pull/941/commits/fab245a077d02a09630f74270806c0c534a4ff95)

#### Bug Fixes

- **Fixed bug related to importing native dependencies:** [#933](https://github.com/mb-later/repo/pull/933)
...
- **Migrated to Jest:** [#768](https://github.com/mb-later/repo/pull/768)
...
- **Added support for Yarn:** [#451](https://github.com/mb-later/repo/pull/451)
- **Added support for Flow:** [#425](https://github.com/mb-later/repo/pull/425)
- **Added support for stylelint:** [#911](https://github.com/mb-later/repo/pull/911)
- **Added support for electron-builder:** [#876](https://github.com/mb-later/repo/pull/876)
- **Added optional support for SASS:** [#880](https://github.com/mb-later/repo/pull/880)
- **Added support for eslint-plugin-flowtype:** [#911](https://github.com/mb-later/repo/pull/911)
- **Added support for appveyor:** [#280](https://github.com/mb-later/repo/pull/280)
- **Added support for webpack dlls:** [#860](https://github.com/mb-later/repo/pull/860)
- **Route based code splitting:** [#884](https://github.com/mb-later/repo/pull/884)
- **Added support for Webpack Bundle Analyzer:** [#922](https://github.com/mb-later/repo/pull/922)

#### Improvements

- **Parallelize renderer and main build processes when running `npm run build`**
- **Dynamically generate electron app menu**
- **Improved vscode integration:** [#856](https://github.com/mb-later/repo/pull/856)

#### Bug Fixes

- **Fixed hot module replacement race condition bug:** [#917](https://github.com/mb-later/repo/pull/917) [#920](https://github.com/mb-later/repo/pull/920)

# 0.10.0 (2016.4.18)

#### Improvements

- **Use Babel in main process with Webpack build:** [#201](https://github.com/mb-later/repo/pull/201)
- **Change targets to built-in support by webpack:** [#197](https://github.com/mb-later/repo/pull/197)
- **use es2015 syntax for webpack configs:** [#195](https://github.com/mb-later/repo/pull/195)
- **Open application when webcontent is loaded:** [#192](https://github.com/mb-later/repo/pull/192)
- **Upgraded dependencies**

#### Bug fixed

- **Fix `npm list electron-prebuilt` in package.js:** [#188](https://github.com/mb-later/repo/pull/188)
...
- **Upgraded dependencies**
- **Added `npm run dev` command:** [#162](https://github.com/mb-later/repo/pull/162)
- **electron to v0.37.2**

#### Breaking Changes

- **css module as default:** [#154](https://github.com/mb-later/repo/pull/154).
- **set default NODE_ENV to production:** [#140](https://github.com/mb-later/repo/issues/140)
...
- **Fix lint errors**
- **Fix Webpack publicPath for production builds**: [#119](https://github.com/mb-later/repo/issues/119).
...
- **Add json-loader**: [#128](https://github.com/mb-later/repo/issues/128).
...
- **Fixed npm script on windows 10:** [#103](https://github.com/mb-later/repo/issues/103).
- **history and react-router version bump**: [#109](https://github.com/mb-later/repo/issues/109), [#110](https://github.com/mb-later/repo/pull/110).
...
- **Fixed process.env.NODE_ENV variable in webpack:** [#74](https://github.com/mb-later/repo/pull/74).
- **add missing object-assign**: [#76](https://github.com/mb-later/repo/pull/76).
- **packaging in npm@3:** [#77](https://github.com/mb-later/repo/pull/77).
- **compatibility in windows:** [#100](https://github.com/mb-later/repo/pull/100).
- **disable chrome debugger in production env:** [#102](https://github.com/mb-later/repo/pull/102).
...
- **Initialize ExtractTextPlugin once:** [#64](https://github.com/mb-later/repo/issues/64).

# 0.6.2 (2015.10.18)

#### Bug fixed

- **Babel plugins production env not be set properly:** [#57](https://github.com/mb-later/repo/issues/57).
...
- **Run tests with babel-register:** [#29](https://github.com/mb-later/repo/issues/29).
...
- **Simplify webpack config** see [#50](https://github.com/mb-later/repo/pull/50).
...
- **Eslint:** typo, [#17](https://github.com/mb-later/repo/issues/17) and improve `.eslintrc`
...
- **Npm Script:** typo, [#6](https://github.com/mb-later/repo/pull/6)
- **Missing css:** [#7](https://github.com/mb-later/repo/pull/7)
